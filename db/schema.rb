...
ActiveRecord::Schema[7.2].define(version: 2025_06_06_001516) do
  ...
  create_table "contact_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["import_id"], name: "index_contact_users_on_import_id"
  ...
  add_foreign_key "contact_users", "imports"
